...
import { Search, Menu, X, Copy } from 'lucide-react'
import Link from 'next/link'
import Image from 'next/image'
import { useState } from 'react'
import { ADDRESS_OWNER, truncateAddress } from '~/lib/utils'
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <code className="relative rounded px-[0.3rem] py-[0.2rem] font-mono text-sm bg-secondary/10 hover:bg-secondary/20">
                {truncateAddress(ADDRESS_OWNER)}
              </code>
